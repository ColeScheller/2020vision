...
class PowerCellPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [0.0, 43.82252559726962]
        self.__hsv_threshold_saturation = [102.03237410071944, 255.0]
...
while(True):
    ...
    pipe = PowerCellPipeline()
    pipe.pipe(frame)
    print("Blobs: ")
    print(pipe.find_blobs_output)
